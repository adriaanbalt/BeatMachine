...
exports.account = function(req, res){
	log.debug('Displaying account.');
	res.render('account');
	log.debug('Done displaying account.');
};

exports.create = function(req, res){
	log.debug('Displaying create.');
	res.render('create');
	...
	log.debug('Done displaying create.');
};

exports.howto = function(req, res){
	log.debug('Displaying howto.');
	res.render('howto');
	log.debug('Done displaying howto.');
};

exports.login = function(req, res){
	log.debug('Displaying login.');
	res.render('login');
	log.debug('Done displaying login.');
};
